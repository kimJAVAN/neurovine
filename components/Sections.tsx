...
export const Hero: React.FC = () => {
  return (
    <section id="summary" className="relative pt-40 pb-20 overflow-hidden min-h-screen flex items-center bg-[#01040a]">
      ...
      <div className="absolute bottom-[10%] right-[0%] w-[600px] h-[600px] bg-emerald-500/[0.04] rounded-full blur-[140px] -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-10">
          ...
          <button className="flex items-center gap-4 px-10 py-5 bg-white text-black font-bold text-[12px] tracking-[0.2em] rounded-full hover:bg-emerald-50 transition-all group shadow-[0_20px_40px_rgba(255,255,255,0.05)] uppercase">
        ...
        <div className="relative group animate-float">
          <div className="relative z-10 aspect-square rounded-[3.5rem] overflow-hidden glass p-6 border border-white/10 shadow-2xl bg-black/40">
             <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent z-10 pointer-events-none"></div>
             {/* 세련된 그린톤 반도체/회로 이미지 */}
             <img 
               src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=1200" 
               alt="Neural Semiconductor Architecture" 
               className="w-full h-full object-cover rounded-[3rem] opacity-90 transition-transform duration-1000 group-hover:scale-105"
             />
             
             {/* Central Glow Chip Area */}
             <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
                <div className="w-80 h-80 bg-emerald-500/15 rounded-full blur-[90px] animate-pulse"></div>
                <div className="relative p-10 bg-black/70 backdrop-blur-2xl rounded-[2.5rem] border border-emerald-500/30 shadow-[0_0_100px_rgba(52,211,153,0.3)]">
                  <Cpu className="w-24 h-24 text-emerald-400 drop-shadow-[0_0_30px_#10b981]" strokeWidth={1} />
                </div>
             </div>
             
             {/* High Fidelity Integration Badge */}
             <div className="absolute bottom-12 right-12 glass px-8 py-5 rounded-2xl border border-white/10 z-30 shadow-2xl backdrop-blur-3xl">
...
export const NeuralBridge: React.FC = () => {
  return (
    <section className="py-32 relative overflow-hidden bg-[#01040a]">
      <div className="absolute left-1/2 top-0 -translate-x-1/2 w-full h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
...
export const StructuralFailure: React.FC = () => {
  return (
    <section id="gap" className="py-32 border-t border-white/5 relative bg-[#01040a]">
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-emerald-500/[0.03] rounded-full blur-[160px] -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-20 text-center">
          <div className="space-y-6 group">
            <p className="text-6xl font-bold tracking-tighter text-emerald-400 drop-shadow-[0_0_20px_rgba(52,211,153,0.4)] transition-transform duration-500 group-hover:scale-110">
          ...
          <div className="space-y-6 group">
            <p className="text-6xl font-bold tracking-tighter text-emerald-400 drop-shadow-[0_0_20px_rgba(52,211,153,0.4)] transition-transform duration-500 group-hover:scale-110 font-mono">
...
export const AccessRights: React.FC = () => {
  return (
    <section id="solution" className="py-32 border-t border-white/5 bg-[#01040a]">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div className="relative aspect-square flex items-center justify-center">
          ...
          <div className="w-32 h-32 bg-emerald-500 rounded-full flex items-center justify-center shadow-[0_0_100px_rgba(52,211,153,0.5)] z-10 border-[8px] border-[#01040a]">
            <Key className="w-14 h-14 text-slate-950" strokeWidth={2.5} />
          </div>
          
          <div className="absolute top-[12%] right-[12%] text-[11px] font-bold text-slate-600 tracking-[0.3em] uppercase bg-black/60 px-5 py-2 backdrop-blur-xl rounded-full border border-white/5 shadow-xl">Skills</div>
          <div className="absolute bottom-[22%] left-[8%] text-[11px] font-bold text-slate-600 tracking-[0.3em] uppercase bg-black/60 px-5 py-2 backdrop-blur-xl rounded-full border border-white/5 shadow-xl">Expertise</div>
          <div className="absolute top-[50%] left-[-10%] -translate-y-1/2 text-[11px] font-bold text-slate-600 tracking-[0.3em] uppercase bg-black/60 px-5 py-2 backdrop-blur-xl rounded-full border border-white/5 shadow-xl">Data</div>
        </div>
...
export const TechStack: React.FC = () => {
  return (
    <section id="product" className="py-32 border-t border-white/5 relative bg-[#01040a]">
...
export const MarketOpportunity: React.FC = () => {
  return (
    <section id="market" className="py-32 border-t border-white/5 relative bg-[#01040a]">
...
export const StrategicPositioning: React.FC = () => {
  return (
    <section className="py-40 border-t border-white/5 relative bg-[#01040a]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="aspect-[21/9] relative border border-white/10 rounded-[3.5rem] overflow-hidden bg-slate-950/40 shadow-inner group">
           ...
           <div className="absolute bottom-12 left-1/2 -translate-x-1/2 text-[12px] font-bold text-slate-700 tracking-[0.6em] uppercase bg-black/60 px-10 py-4 backdrop-blur-md rounded-full border border-white/5 shadow-xl">Transfer Speed</div>
           <div className="absolute left-12 top-1/2 -rotate-90 origin-left -translate-y-1/2 text-[12px] font-bold text-slate-700 tracking-[0.6em] uppercase bg-black/60 px-10 py-4 backdrop-blur-md rounded-full border border-white/5 shadow-xl">Invasiveness</div>
...
export const Vision: React.FC = () => {
  return (
    <section id="vision" className="py-44 relative overflow-hidden bg-[#01040a]">
...
export const Architects: React.FC = () => {
  return (
    <section className="py-32 border-t border-white/5 relative overflow-hidden bg-[#01040a]">
      <div className="max-w-7xl mx-auto px-6">
...
export const CTA: React.FC = () => {
  return (
    <section className="py-44 border-t border-white/5 relative overflow-hidden bg-[#01040a]">
